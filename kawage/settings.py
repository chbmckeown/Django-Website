"""
Django settings for kawage project.
...
PROJECT_DIR = os.path.join(BASE_DIR, "kawage")

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = "django-insecure-sa7o4+=(8@0g6$o=fks(37fh@-th958^tn=9+6srutxe84mdll"
...
WSGI_APPLICATION = "kawage.wsgi.application"
